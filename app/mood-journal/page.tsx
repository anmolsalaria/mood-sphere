...
export default function MoodJournalPage() {
  const { currentMood, getMoodGradient } = useMood()
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${getMoodGradient(currentMood)} text-white`}>
      <div className="container mx-auto px-6 py-8">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          ...
          <p className="text-gray-300 text-lg">Track your emotions and reflect on your daily experiences</p>
        </motion.div>
